  ...
  return (
    ...
    >
      ...
      <div className="relative flex items-center justify-center sm:justify-start">
        <div className="relative">
          <Image
            ...
            width={180}
            height={180}
            className="w-37.5 sm:w-45 h-37.5 object-contain rounded-xl border border-emerald-100 bg-white"
          />
      ...
      <div className="flex flex-col justify-between gap-4">
        <div>
          <h3 className="text-lg sm:text-xl md:text-2xl font-semibold text-emerald-950 wrap-break-word">
            {item.name}
          </h3>
          ...
          <div className="mt-3 grid grid-cols-1 md:grid-cols-[1fr_auto] md:items-center gap-2">
            ...
            <div className="md:justify-self-end">
              <div className="min-w-42.5 flex justify-end">
                {discountPercent > 0 ? (
        ...
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-3">
          {/* Stepper */}
          <div className="inline-flex items-center border border-emerald-200 rounded-xl overflow-hidden bg-white p-1">
            <Button
              onClick={handleDecrement}
              disabled={!canDecrement}
              aria-label={t("common.decreaseQuantity") as string}
              className="px-3 py-2 bg-emerald-600 text-white hover:bg-emerald-700 hover:text-white disabled:bg-emerald-50 disabled:opacity-40 disabled:cursor-not-allowed cursor-pointer"
              variant="ghost"
            >
              <MinusIcon className="w-5 h-5" />
            </Button>
            <span
              className="px-5 text-base min-w-12 text-center tabular-nums"
              aria-live="polite"
              aria-atomic="true"
            >
              {item.quantity}
            ...
            <Button
              ...
              className="px-3 py-2 bg-emerald-600 text-white hover:bg-emerald-700 cursor-pointer"
            >
          ...
          <Button
            ...
            className="text-sm font-semibold text-red-600 border border-red-300 hover:bg-red-50 px-4 py-2 rounded-xl cursor-pointer"
          >
            {t("common.delete")}
          </Button>
        </div>
