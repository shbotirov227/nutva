...
import { X, Leaf, Clock, Gift, Shield, Sparkles, Percent } from "lucide-react";
...
export function DiscountPopup({ isVisible, onClose }: DiscountPopupProps) {
    const [timeLeft, setTimeLeft] = useState({ hours: 1, minutes: 59, seconds: 59 }); // Reset timer for new offer
                        ...
                        <div className="relative max-h-[calc(100vh-2rem)] overflow-x-hidden overflow-y-auto overscroll-contain rounded-2xl border-2 border-emerald-300 bg-gradient-to-br from-white via-emerald-50 to-green-50 shadow-2xl">
                            ...
                            <div className="relative px-4 pb-3 pt-6 text-center sm:px-5 sm:pt-8">
                                ...
                                >
                                    ...
                                    <p className="mt-1.5 text-sm font-medium text-gray-600">
                                        {t("discountPopup.subtitle", "Faqat bugun uchun maxsus narxlar!")}
                                    </p>
                                </motion.div>
                            </div>
                            ...
                            <div className="px-4 py-2 sm:px-5">
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <div className="mb-1.5 text-3xl font-bold tracking-tight sm:text-4xl">
                                            20% SALE
                                        </div>
                                        <div className="text-sm font-medium opacity-95">
                                            {t("discountPopup.discountForFirst", "🎁 Barcha mahsulotlarga")}
                                        </div>
                                    </motion.div>
                                    ...
                                    <div className="mt-3 flex items-center justify-center gap-2.5 text-xs text-emerald-50">
                                        ...
                                        <div className="flex items-center gap-1">
                                            ...
                                            <span>{t("discountPopup.quality", "Kafolat")}</span>
                                        </div>
                                    </div>
                                </motion.div>
                            </div>
                            ...
                            >
                                <div className="flex items-center justify-center gap-2 text-gray-700 mb-3">
                                    ...
                                    <span className="text-xs font-semibold">{t("discountPopup.limitedTimeOffer", "⏰ Shoshiling, vaqt ketmoqda:")}</span>
                                </div>
                                ...
                                <div className="bg-gradient-to-r from-emerald-50 to-green-50 rounded-xl p-3 border border-emerald-200">
                                    <div className="grid grid-cols-3 gap-3 text-center">
                                        ...
                                        >
                                            ...
                                            <span className="text-[10px] text-gray-700 font-semibold">{t("discountPopup.benefitNatural", "Tabiiy")}</span>
                                        </motion.div>
                                        <motion.div
                                            className="flex flex-col items-center"
                                            whileHover={{ scale: 1.05 }}
                                        ...
                                        >
                                            ...
                                            <span className="text-[10px] text-gray-700 font-semibold">{t("discountPopup.benefitFreeDelivery", "Yetkazish")}</span>
                                        </motion.div>
                                    </div>
                                </div>
                            </motion.div>
