...
const BlogCard = ({ id, url, imgUrl, title, content }: BlogCardProps) => {
	return (
		<Card className="w-[100%] min-h-[100%] bg-[#FFF7ED] border-2 shadow-[10px_10px_10px_rgba(0,0,0,0.1),_10px_10px_10px_rgba(0,0,0,0.1)] rounded-xl hover:shadow-[10px_10px_10px_rgba(0,0,0,0.2),_10px_10px_10px_rgba(0,0,0,0.2)] transition-shadow duration-300 flex flex-col">
			...
			<CardFooter className="px-6 pb-6">
				<Link
					...
					className="text-blue-600 text-xl transition-all hover:underline font-medium"
				>
					Read More
				</Link>
			</CardFooter>
