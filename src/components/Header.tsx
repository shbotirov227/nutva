...
const NavLink = ({
  ...
  <Link
    ...
    ref={refProp}
    className={
      "text-red-500 px-4 min-lg:px-2 text-xl max-h-lg:text-lg transition-all delay-75 pb-2 border-b-transparent border-b-2 hover:border-b-white focus:outline-none focus-visible:ring-2 ring-white " +
      className
    }
    onClick={onClick}
    tabIndex={0}
