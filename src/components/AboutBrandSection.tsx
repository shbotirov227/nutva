...
export default function AboutBrandSection() {
	...
	return (
		<div className="py-32" style={{ backgroundImage: `url(${BgImage.src})`, backgroundSize: "cover", backgroundPosition: "center" }}>
			<Container className="flex flex-col md:flex-row items-center justify-center">
				<div className="flex items-center justify-between p-15 my-15 rounded-xl bg-white shadow-[10px_10px_10px_rgba(0,0,0,0.1),_10px_10px_10px_rgba(0,0,0,0.1)]">
