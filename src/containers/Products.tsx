        ...
        {(isLoading || !products?.length
          ...
          : products?.map((product: GetAllProductsType[number], index: number) => {
            ...
            return (
              ...
              >
                <div
                  className={`flex flex-col justify-between h-full w-full rounded-xl shadow-md p-4 box-border ${isActive
                    ? "shadow-[10px_10px_10px_rgba(0,0,0,0.3),_10px_10px_10px_rgba(0,0,0,0.3)]"
                    : ""
                    }`}
                  style={{
                    backgroundColor: productBgColors[product.name as ProductName],
                  }}
                >
                  <div className="flex flex-col sm:flex-row sm:items-start gap-4">
                    ...
                    <div className="flex flex-col justify-between w-full sm:w-1/2">
                      ...
                      <p className="mt-2 text-white text-base sm:text-lg leading-snug">
                        {product.description}
                      </p>
                  ...
                  <div className="flex flex-col sm:flex-row gap-4 mt-6">
                    <a
                      href="/contact"
                      className="bg-white text-black text-center px-6 py-3 rounded-lg font-bold"
                    >
                      Купить
                    </a>
                    <a
                      href={`/product/${product.slug}`}
                      className="text-white underline text-center px-6 py-3"
